...
import { QrCode, Package, Scan, Users } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Overview of your product QR codes and analytics.</p>
      </div>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            ...
            <Card className="col-span-3">
              <CardHeader>
                ...
                <CardDescription>Latest product QR code scans</CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    <div key={i} className="flex items-center gap-4">
                      ...
                      <div className="flex-1 space-y-1">
                        ...
                        <p className="text-xs text-muted-foreground">
                          Scanned {Math.floor(Math.random() * 60)} minutes ago
                        </p>
                      </div>
                    </div>
                  ))}
        ...
        <TabsContent value="analytics" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Detailed analytics for your QR codes and products</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="reports" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Generate and download reports about your QR code performance</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-[400px] w-full rounded-md bg-muted/30 flex items-center justify-center">
